...
const ConductMain = () => (
  <Section section={{ style: { backgroundColor: styles.mainColor3 } }}>
    <div className="central-container">
      <p>
        Below is a short version of our Code of Conduct. You can download
      ...
      <p>
        <strong>
          ...
          conduct.
        </strong> As organisers of JSHeroes 2017, the Cluj
      ...
      <p>
        We value your attendance and your participation in the Cluj
        JavaScripters community and expect everyone to accord to the
        community Code of Conduct at all JSHeroes venues and events.
      </p>
    </div>
