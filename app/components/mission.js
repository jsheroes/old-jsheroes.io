  ...
  <Section section={{style: { backgroundColor: styles.mainColor6 }}}>
    <div>
      ...
      <p>
        ...
        for this we’ve designed the event to be JSHeroes, <strong>the first of 
        a series</strong> of Open-Source Community Events by <strong>JavaScript 
        Communities worldwide</strong>.
      </p>
    </div>
